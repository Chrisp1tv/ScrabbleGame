...
abstract public class PlayedWordsValidityManager {
    public static boolean playedWordsAreValid(List<List<LetterInterface>> currentLetters, List<List<LetterInterface>> playedLetters) {
    ...
    public static List<WordInterface> findPlayedWords(List<List<LetterInterface>> currentLetters, List<List<LetterInterface>> playedLetters, PlayerInterface player) throws NonExistentWordException {
